...
def extract_content(response) -> str:
    """Safely extract content from LLM response (dict or object)."""
...
"""
        try:
            ...
            continue  # Fail open on single judge failure
...
"""
        try:
            ...
            critique = "CRITIC FAILURE - VERDICT: REJECT (oracle instability)"
